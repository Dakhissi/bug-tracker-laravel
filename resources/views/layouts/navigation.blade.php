            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-44 w-auto fill-current text-gray-800 dark:text-gray-200" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{ __('messages.page_dashboard') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('projects')" :active="request()->routeIs('projects')">
                        {{ __('messages.page_projects') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('bugs')" :active="request()->routeIs('bugs')">
                        {{ __('messages.page_bug') }}
                    </x-nav-link>
                </div>
            </div>
